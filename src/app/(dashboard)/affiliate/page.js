    ...
    return (
        <div className="fade-in">
            <div className={styles.welcomeSection}>
                ...
                <p className="text-muted">Welcome, {session?.user?.firstName}! Share listings and earn 2% commission on successful rentals.</p>
            </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div style={{ flex: 1 }}>
                            ...
                            <p style={{ fontSize: '14px', margin: '0 0 12px 0', color: 'var(--text-color)' }}>
                                To start earning commissions, please complete your National Identity Number (NIN) verification.
                            </p>
                            <Link href="/affiliate/profile" className="btn btn-sm" style={{ background: 'var(--color-error)', color: 'white', border: 'none' }}>
                                Verify Now
                            </Link>
                        </div>
                    </div>
            ...
            <div className={styles.quickActions}>
                <Link href="/affiliate/links" className={styles.actionCard}>
                    <span className={styles.actionIcon}><LinkIcon size={24} /></span>
                    <div>
